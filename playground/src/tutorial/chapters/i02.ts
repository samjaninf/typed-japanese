...
// 食べる is ichidan: causative 食べさせ, polite 食べさせます (食べさせ + ます)
type 母は私に野菜を食べさせます = \`\${PhraseWithParticle<母, "は">}\${PhraseWithParticle<私, "に">}\${PhraseWithParticle<野菜, "を">}\${ConjugateVerb<食べる, "Causative">}ます\`;
`,
        },
        {
          jp: "毎日子供に勉強させます",
...
// 勉強する → causative 勉強させ → polite 勉強させます (勉強させ + ます)
type 毎日子供に勉強させます = \`\${毎日}\${PhraseWithParticle<子供, "に">}\${ConjugateVerb<勉強する, "Causative">}ます\`;
`,
        },
      ],
    },
