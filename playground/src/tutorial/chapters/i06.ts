...
// 急ぐ(仮定形)=急げ → +ば → 急げば
type 急げば間に合います = \`\${ConjugateVerb<急ぐ, "Hypothetical">}ば、\${ConjugateVerb<間に合う, "Masu">}\`;
`,
        },
        {
          jp: "安ければ、買います",
...
type 安ければ買います = \`\${安い["stem"]}ければ、\${ConjugateVerb<買う, "Masu">}\`;
`,
        },
        {
          jp: "春が来れば、暖かくなる",
...
type 春が来れば暖かくなる = \`\${PhraseWithParticle<CommonNoun<"春">, "が">}\${ConjugateVerb<来る, "Hypothetical">}ば、\${ConjugateAdjective<暖かい, "Adverbial">}なる\`;
`,
        },
      ],
    },
...
type 上手 = NaAdjective & { stem: "上手" };

// 練習する(ない形)=練習し + なければ ; 上手(な形容詞)に + なりません
type 練習しなければ上手になりません = \`\${ConjugateVerb<練習する, "Nai">}なければ\${ConjugateAdjective<上手, "Adverbial">}なりません\`;
`,
        },
      ],
    },
...
// ichidan: 考えれ(仮定形)+ ば + 考える(辞書形)+ ほど ; 分か(ない形)+ なくなる
type 考えれば考えるほど分からなくなる = \`\${ConjugateVerb<考える, "Hypothetical">}ば\${ConjugateVerb<考える, "Dictionary">}ほど\${ConjugateVerb<分かる, "Nai">}なくなる\`;
`,
        },
      ],
    },
