...
type 高いから買いません = \`\${PhraseWithParticle<ConjugateAdjective<高い, "Basic">, "から">}\${ConjugateVerb<買う, "Masen">}\`;
`,
        },
        {
          jp: "忙しいので行きません",
...
type 忙しいので行きません = \`\${PhraseWithParticle<ConjugateAdjective<忙しい, "Basic">, "ので">}\${ConjugateVerb<行く, "Masen">}\`;
`,
        },
        {
          jp: "雨なので休みます",
...
type 雨なので休みます = \`\${雨}なので\${ConjugateVerb<休む, "Masu">}\`;
`,
        },
      ],
    },
...
type 高いですが買います = \`\${PhraseWithParticle<ConjugateAdjective<高い, "Polite">, "が">}\${ConjugateVerb<買う, "Masu">}\`;
`,
        },
        {
          jp: "安いけど買いません",
...
type 安いけど買いません = \`\${PhraseWithParticle<ConjugateAdjective<安い, "Basic">, "けど">}\${ConjugateVerb<買う, "Masen">}\`;
`,
        },
        {
          jp: "行きますが遅れます",
          ...
          zh: "我会去,不过会迟到。",
          code: `import type { GodanVerb, ConjugateVerb, IchidanVerb, PhraseWithParticle } from "typed-japanese";

type 行く = GodanVerb & { stem: "行"; ending: "く" };
type 遅れる = IchidanVerb & { stem: "遅れ"; ending: "る" };

// 行きます + が(逆接の接続助詞) + 遅れます
type 行きますが遅れます = \`\${PhraseWithParticle<ConjugateVerb<行く, "Masu">, "が">}\${ConjugateVerb<遅れる, "Masu">}\`;
`,
        },
      ],
    },
      ...
      examples: [
        {
          ...
          zh: "又便宜,而且方便。",
          code: `import type { IAdjective, NaAdjective, ConjugateAdjective, PhraseWithParticle } from "typed-japanese";

type 安い = IAdjective & { stem: "安"; ending: "い" };
type 便利 = NaAdjective & { stem: "便利" };

// 安い (基本形) + し + 便利です (na-adj 丁寧形)
type 安いし便利です = \`\${PhraseWithParticle<ConjugateAdjective<安い, "Basic">, "し">}\${ConjugateAdjective<便利, "Polite">}\`;
`,
        },
        {
          jp: "雨だし寒いです",
          ...
          zh: "又下雨,而且又冷。",
          code: `import type { CommonNoun, IAdjective, ConjugateAdjective, ConjugateCopula, PhraseWithParticle } from "typed-japanese";

type 雨 = CommonNoun<"雨">;
type 寒い = IAdjective & { stem: "寒"; ending: "い" };

// 雨 + だし (noun + し) + 寒いです (丁寧形)
type 雨だし寒いです = \`\${PhraseWithParticle<ConjugateCopula<雨, "Plain">, "し">}\${ConjugateAdjective<寒い, "Polite">}\`;
`,
        },
      ],
    },
