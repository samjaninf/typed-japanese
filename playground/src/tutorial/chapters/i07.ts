...
type 雨が降っても行きます = \`\${PhraseWithParticle<雨, "が">}\${ConjugateVerb<降る, "Te">}も\${ConjugateVerb<行く, "Masu">}\`;
`,
        },
        {
          jp: "高くても買います",
...
type 高くても買います = \`\${ConjugateAdjective<高い, "Te">}も\${ConjugateVerb<買う, "Masu">}\`;
`,
        },
        {
          jp: "たくさん食べても太りません",
...
type たくさん食べても太りません = \`たくさん\${ConjugateVerb<食べる, "Te">}も\${ConjugateVerb<太る, "Masen">}\`;
`,
        },
      ],
    },
      ...
      examples: [
        {
          ...
          zh: "无论谁来我都不见。",
          code: `import type { Pronoun, IrregularVerb, GodanVerb, ConjugateVerb, PhraseWithParticle } from "typed-japanese";
...
type 誰が来ても会いません = \`\${PhraseWithParticle<誰, "が">}\${ConjugateVerb<来る, "Te">}も\${ConjugateVerb<会う, "Masen">}\`;
`,
        },
        {
          jp: "何を飲んでも眠れません",
...
type 何を飲んでも眠れません = \`\${PhraseWithParticle<何, "を">}\${ConjugateVerb<飲む, "Te">}も\${ConjugateVerb<眠る, "Potential">}ません\`;
`,
        },
      ],
    },
      ...
      examples: [
        {
          ...
          zh: "明明学了却不懂。",
          code: `import type { SuruVerb, GodanVerb, ConjugateVerb } from "typed-japanese";

type 勉強する = SuruVerb<"勉強">;
type 分かる = GodanVerb & { stem: "分か"; ending: "る" };

// 勉強した (ta-form of 勉強する) + のに + 分かりません
type 勉強したのに分かりません = \`\${ConjugateVerb<勉強する, "Ta">}のに\${ConjugateVerb<分かる, "Masen">}\`;
`,
        },
        {
          jp: "薬を飲んだのに治りません",
...
type 薬を飲んだのに治りません = \`\${PhraseWithParticle<薬, "を">}\${ConjugateVerb<飲む, "Ta">}のに\${ConjugateVerb<治る, "Masen">}\`;
`,
        },
        {
          jp: "日曜日なのに働きます",
...
type 日曜日 = CommonNoun<"日曜日">;
type 働く = GodanVerb & { stem: "働"; ending: "く" };

// 日曜日 (noun) + なのに + 働きます
type 日曜日なのに働きます = \`\${日曜日}なのに\${ConjugateVerb<働く, "Masu">}\`;
`,
        },
      ],
    },
      ...
      examples: [
        {
          ...
          zh: "就算练习我也很差。",
          code: `import type { SuruVerb, NaAdjective, ConjugateVerb, ConjugateAdjective } from "typed-japanese";

type 練習する = SuruVerb<"練習">;
type 下手 = NaAdjective & { stem: "下手" };

// 練習して (te-form of 練習する) + も + 下手 + です
type 練習しても下手です = \`\${ConjugateVerb<練習する, "Te">}も\${ConjugateAdjective<下手, "Polite">}\`;
`,
        },
        {
          jp: "練習したのに下手です",
...
// 練習した (ta-form of 練習する) + のに + 下手 + です
type 練習したのに下手です = \`\${ConjugateVerb<練習する, "Ta">}のに\${ConjugateAdjective<下手, "Polite">}\`;
`,
        },
      ],
    },
