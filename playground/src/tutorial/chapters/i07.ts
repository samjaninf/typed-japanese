      ...
      examples: [
        {
          ...
          zh: "无论谁来我都不见。",
          code: `import type { ProperNoun, IrregularVerb, GodanVerb, ConjugateVerb } from "typed-japanese";
      ...
      examples: [
        {
          ...
          zh: "就算练习我也很差。",
          code: `import type { ProperNoun, IrregularVerb, ConjugateVerb, ConjugateCopula } from "typed-japanese";
