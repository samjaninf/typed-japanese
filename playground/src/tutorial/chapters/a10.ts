...
type 彼 = Pronoun<"彼">;
type 英語 = CommonNoun<"英語">;
type 中国語 = CommonNoun<"中国語">;
...
`,
        },
        {
          ...
          zh: "她不仅漂亮,而且温柔。",
          code: `import type { Pronoun, IAdjective, ConjugateAdjective, PhraseWithParticle } from "typed-japanese";
      ...
      examples: [
        {
          ...
          zh: "他别说有钱了,反而很穷。",
          code: `import type { CommonNoun, NaAdjective, Pronoun, PhraseWithParticle, ConjugateCopula } from "typed-japanese";

type 彼 = Pronoun<"彼">;
type お金持ち = CommonNoun<"お金持ち">;
type 貧乏 = NaAdjective & { stem: "貧乏" };

// 彼 は + お金持ち + どころか + 貧乏 (な形容詞) + だ
type 彼はお金持ちどころか貧乏だ = \`\${PhraseWithParticle<彼, "は">}\${お金持ち}どころか\${ConjugateCopula<貧乏["stem"], "Plain">}\`;
`,
        },
        {
          jp: "休むどころか働いた",
