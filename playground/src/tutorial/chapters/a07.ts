...
// 夢を + 見て(て形) + いる + かのようだ
type 夢を見ているかのようだ = \`\${PhraseWithParticle<夢, "を">}\${ConjugateVerb<見る, "Te">}\${ConjugateVerb<いる, "Dictionary">}かのようだ\`;
`,
        },
        {
          jp: "彼女はまるで天使であるかのようだ",
...
`,
        },
        {
          ...
          zh: "白得仿佛正在下雪一样。",
          code: `import type { CommonNoun, GodanVerb, ConjugateVerb, IchidanVerb, IAdjective, ConjugateAdjective, PhraseWithParticle } from "typed-japanese";
...
type 雪が降っているかのように白い = \`\${PhraseWithParticle<雪, "が">}\${ConjugateVerb<降る, "Te">}\${ConjugateVerb<いる, "Dictionary">}かのように\${ConjugateAdjective<白い, "Basic">}\`;
`,
        },
      ],
    },
      ...
      examples: [
        {
          ...
          zh: "他看着我,仿佛在说「快走」似的。",
          code: `import type { Pronoun, GodanVerb, ConjugateVerb, IchidanVerb, IAdjective, ConjugateAdjective, PhraseWithParticle } from "typed-japanese";
...
// 早く(連用形) + 行け(命令形) + とばかりに + 彼を + 見た(た形)
type 早く行けとばかりに彼を見た = \`\${ConjugateAdjective<早い, "Adverbial">}\${ConjugateVerb<行く, "Imperative">}とばかりに\${PhraseWithParticle<彼, "を">}\${ConjugateVerb<見る, "Ta">}\`;
`,
        },
        {
          jp: "待っていたとばかりに笑った",
          ...
          code: `import type { GodanVerb, IchidanVerb, ConjugateVerb } from "typed-japanese";

type 待つ = GodanVerb & { stem: "待"; ending: "つ" };
type 笑う = GodanVerb & { stem: "笑"; ending: "う" };
type いる = IchidanVerb & { stem: "い"; ending: "る" };

// 待って(て形) + いた(いるのた形) + とばかりに + 笑った(た形)
type 待っていたとばかりに笑った = \`\${ConjugateVerb<待つ, "Te">}\${ConjugateVerb<いる, "Ta">}とばかりに\${ConjugateVerb<笑う, "Ta">}\`;
`,
        },
        {
          jp: "何も聞いていないとばかりに歩いた",
          ...
          code: `import type { Pronoun, GodanVerb, IchidanVerb, ConjugateVerb } from "typed-japanese";
...
// 何 + も + 聞いて(て形) + いない(いるのない形 + ない) + とばかりに + 歩いた(た形)
type 何も聞いていないとばかりに歩いた = \`\${何}も\${ConjugateVerb<聞く, "Te">}\${ConjugateVerb<いる, "Nai">}ないとばかりに\${ConjugateVerb<歩く, "Ta">}\`;
`,
        },
      ],
    },
