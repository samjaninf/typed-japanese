...
`,
        },
        {
          ...
          zh: "我的爱好是读书。",
          code: `import type { Pronoun, CommonNoun, GodanVerb, ConjugateVerb, PhraseWithParticle } from "typed-japanese";

type 私 = Pronoun<"私">;
type 趣味 = CommonNoun<"趣味">;
type 本 = CommonNoun<"本">;
...
`,
        },
        {
          ...
          zh: "小时候,我经常哭。",
          code: `import type { Adverb, CommonNoun, GodanVerb, ConjugateVerb, PhraseWithParticle, ConnectedPhrases } from "typed-japanese";
...
// よく + 泣き (ます形) + ました
type よく泣きました = \`\${よく}\${ConjugateVerb<泣く, "MasuPast">}\`;
...
`,
        },
        {
          ...
          zh: "天冷的时候,我会穿大衣。",
          code: `import type { CommonNoun, IAdjective, ConjugateAdjective, IchidanVerb, ConjugateVerb, PhraseWithParticle, ConnectedPhrases } from "typed-japanese";

type 寒い = IAdjective & { stem: "寒"; ending: "い" };
type コート = CommonNoun<"コート">;
type 着る = IchidanVerb & { stem: "着"; ending: "る" };

// 寒い (基本形) + とき
type 寒いとき = \`\${ConjugateAdjective<寒い, "Basic">}とき\`;
// コート + を + 着 (ます形) + ます
type コートを着ます = \`\${PhraseWithParticle<コート, "を">}\${ConjugateVerb<着る, "Masu">}\`;
