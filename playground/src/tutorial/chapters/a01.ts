...
// 先生 + が + おっしゃいました. おっしゃる is an honorific godan verb whose ます形 is
// the irregular おっしゃい (not おっしゃり); the past おっしゃいました is a conjugated
// verb form (NOT a noun), so it is spelled inline as a literal.
...
// Use お〜になる ONCE; do not add 〜られる on top of it. なる is a real godan verb,
// so になります = に + ConjugateVerb<なる, "Masu">.
type 社長が本をお読みになります = \`\${PhraseWithParticle<社長, "が">}\${PhraseWithParticle<本, "を">}お\${ConjugateVerb<読む, "MasuStem">}に\${ConjugateVerb<なる, "Masu">}\`;
`,
        },
      ],
    },
...
type 少々お待ちいただけますか = \`\${少々}お\${ConjugateVerb<待つ, "MasuStem">}いただけますか\`;
`,
        },
        {
          jp: "資料をご確認いただきました",
...
type 資料 = CommonNoun<"資料">;
// ご + [サ変 noun 確認] + いただきました — humble thanks for a completed action.
type 確認 = CommonNoun<"確認">;

// 資料 + を + ご + 確認 + いただきました
type 資料をご確認いただきました = \`\${PhraseWithParticle<資料, "を">}ご\${確認}いただきました\`;
`,
        },
        {
...
type お願い = CommonNoun<"お願い">;
// いたす is the humble form of する; here as いたします.
type する = IrregularVerb & { dictionary: "する" };

// どうぞよろしく + お願い + いたし(ます形) + ます
type どうぞよろしくお願いいたします = \`どうぞよろしく\${お願い}いた\${ConjugateVerb<する, "Masu">}\`;
`,
        },
        {
          ...
          zh: "实在不好意思,请您稍等一下。",
          code: `import type { Adverb, CommonNoun, GodanVerb, ConjugateVerb, ConnectedPhrases, PhraseWithParticle } from "typed-japanese";

type 恐れ = CommonNoun<"恐れ">;
type 少々 = Adverb<"少々">;
type 入る = GodanVerb & { stem: "入"; ending: "る" };
type 待つ = GodanVerb & { stem: "待"; ending: "つ" };

// 恐れ + 入り(ます形) + ます + が(conjunctive「but」)  →  cushioning opener
type 恐れ入りますが = PhraseWithParticle<\`\${恐れ}\${ConjugateVerb<入る, "Masu">}\`, "が">;
// 少々 + お + 待ち(ます形) + ください
type 少々お待ちください = \`\${少々}お\${ConjugateVerb<待つ, "MasuStem">}ください\`;
